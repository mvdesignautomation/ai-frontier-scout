...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DnqLLvvU.mjs");
...
var manifest = { "1c5f8f6d4a744b451fb065d2d6a2bef09c7ef419d1fe088ec5c08f797eb37c77": {
	functionName: "runLiveScout_createServerFn_handler",
	importer: () => import("./run-BayL8rS2.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DFROjZhu.mjs").then((n) => n.t),
